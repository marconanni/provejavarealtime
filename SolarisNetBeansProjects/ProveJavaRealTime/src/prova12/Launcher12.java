 ...
 * @author root
 */
public class Launcher12 extends RealtimeThread {


    public static void main (String [] args ){

        Launcher12 launcher = new Launcher12();
    ...
    public void run() {
        ...
        BadThread12 th1 = new BadThread12();
        ...
        try {
            ...
            Logger.getLogger(Launcher12.class.getName()).log(Level.SEVERE, null, ex);
        }
