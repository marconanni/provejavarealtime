 ...
 * @author root
 */
public class Launcher14 extends RealtimeThread {


    public static void main (String [] args ){

        Launcher14 launcher = new Launcher14();
    ...
    public void run() {
        ...
        BadThread14 th1 = new BadThread14();
        ...
        DeadlineMissedHandler14 handler = new DeadlineMissedHandler14(th2, PriorityScheduler.instance().getNormPriority()+3, "handler");
        ...
        try {
            ...
            Logger.getLogger(Launcher14.class.getName()).log(Level.SEVERE, null, ex);
        }
