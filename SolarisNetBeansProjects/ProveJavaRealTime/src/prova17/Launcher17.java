...
public class Launcher17 extends RealtimeThread {
    ...
    public void run() {
        ...
        th1.setBadExcecutionTime(220);
        th1.setBadIteration(1);
        th1.setNumberOfIterations(4);

        SleepingHandler handler = new SleepingHandler(th1, PriorityScheduler.instance().getNormPriority()+2, "SkipHandler",0);
        ...
        BadThread th2 =  new BadThread();
        RelativeTime period2 = new RelativeTime(100, 0);
        th2.setReleaseParameters(new PeriodicParameters(period));
        th2.setName("Thread2");
        th2.setPriority(PriorityScheduler.instance().getNormPriority()+1);
        th2.setExcecutionTime(10);
        th2.setBadExcecutionTime(220);
        th2.setBadIteration(1);
        th2.setNumberOfIterations(4);

        SleepingHandler handler2 = new SleepingHandler(th2, PriorityScheduler.instance().getNormPriority()+2, "SkipHandler",0);
        handler2.setSleepingTime(0);

        th2.setDeadlineMissedHandler(handler2);
