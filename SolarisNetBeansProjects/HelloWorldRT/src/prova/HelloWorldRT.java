...
public class HelloWorldRT {
    ...
    static final int ITERATIONS = 1000;          // Number of iterations of the periodic thread
    static final int PERIOD = 20;                  // Period in milliseconds
        ...
        public void run() {
            ...
            for (int i = 0; i < ITERATIONS; i++) {
                if ( !waitForNextPeriod() ) {
                    System.out.println(" Deadline missed at loop " + i);

                    // Even if the deadline is missed, we still need to
